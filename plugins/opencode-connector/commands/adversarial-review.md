---
description: Run an adversarial Red Team code review with OpenCode focusing on security vulnerabilities, edge cases, and exploit vectors
...
Delegate an adversarial Red Team review to OpenCode through the bundled bridge.
