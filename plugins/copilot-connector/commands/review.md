---
description: Run a Copilot code review of the current git scope and return a schema-validated verdict
...
Delegate a review to Copilot through the bundled bridge.
