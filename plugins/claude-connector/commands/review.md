---
description: Run a Claude Code code review of the current git scope and return a schema-validated verdict
...
Delegate a review to Claude Code through the bundled bridge.
