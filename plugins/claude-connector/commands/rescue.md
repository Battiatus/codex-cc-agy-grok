---
description: Run a rescue operation with Claude Code in write mode to diagnose and fix errors, failing tests, or broken builds with Git rollback tracking
...
Run an emergency rescue operation with Claude Code through the bundled bridge in write mode.
