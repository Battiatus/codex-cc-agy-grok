...
Delegate bounded, git-scoped review and coding tasks to the local Claude Code CLI from Codex, Claude Code, Grok Build, or Antigravity.
...
- Target executable: `claude`, resolved through a native binary, an npm shim entrypoint or a shebang, so Windows `.cmd` shims work
