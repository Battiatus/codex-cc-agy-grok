---
description: Run a rescue operation with Codex in write mode to diagnose and fix errors, failing tests, or broken builds with Git rollback tracking
...
Run an emergency rescue operation with Codex through the bundled bridge in write mode.
