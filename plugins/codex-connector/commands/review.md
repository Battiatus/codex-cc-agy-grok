---
description: Run a Codex code review of the current git scope and return a schema-validated verdict
...
Delegate a review to Codex through the bundled bridge.
