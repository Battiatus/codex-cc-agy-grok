...
function helpText(config) {
  return {
    ...
    usage: [
      ...
      'run --prompt "<task>" [--mode review|write --confirm-write] [--schema review|<path>] [--expect-response <text>] [--stream] [--verbose] [review options]',
      ...
      "status [job-id] [--all] [--reap] [--tail <lines>] [--follow] [--format json|markdown]",
