---
description: Run a Antigravity code review of the current git scope and return a schema-validated verdict
...
Delegate a review to Antigravity through the bundled bridge.
