---
description: Run a Qwen Code code review of the current git scope and return a schema-validated verdict
...
Delegate a review to Qwen Code through the bundled bridge.
