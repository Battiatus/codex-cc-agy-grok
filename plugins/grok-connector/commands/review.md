---
description: Run a Grok Build code review of the current git scope and return a schema-validated verdict
...
Delegate a review to Grok Build through the bundled bridge.
